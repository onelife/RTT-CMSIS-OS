...
#define osCMSIS_KERNEL      (uint32_t)((RT_VERSION << 24) | (RT_SUBVERSION << 16) | RT_REVISION)
...
#define _NUM2STR(n)         #n
#define osKernelSystemId    "RT-Thread V" _NUM2STR(RT_VERSION) "." _NUM2STR(RT_SUBVERSION) "." _NUM2STR(RT_REVISION)
